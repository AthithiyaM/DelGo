...
def is_point_an_eye(board: Board, point: Point, color):
    ...
    4. If point is edge/corner --> check that all corners are controlled
    5. If point is inside the board --> check that at least 3 corners are controlled
    '''
    ...
    for corner in corners:
        if board.is_on_grid(corner):
            ...
            if corner_color == color: friendly_corners += 1
        else: 
            off_board_corners += 1
